...
export function CartItem({ item }: { item: CartItemData }) {
  ...
  return (
    <RetroContainer className="p-4 mb-4">
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-gray-600 font-bold mb-3 md:mb-0">
            ${item.price} x {item.quantity}
          </p>

          {/* Quantity controls - visible only on mobile */}
          <div className="flex items-center gap-2 mt-3 md:hidden">
            ...
            <Button
              ...
              className="ml-auto bg-red-400 hover:bg-red-300 text-sm px-2 py-1"
            >
              X
            </Button>
          </div>
        ...
        {/* Quantity controls - visible only on desktop */}
